...
# TODO: Switch to lumos.context.Context (which this is a copy of; diff to see changes) and restructure project
class Context:
  ...
  default_log_file = os.path.join(default_base_dir, "../logs", "tang.log")
  ...
  def __init__(self, argv=None, description=default_description, parent_argparsers=[]):
    ...
    guiGroup.add_argument('--gui', dest='gui', action='store_true', default=False, help="display GUI interface/windows?")
    guiGroup.add_argument('--no_gui', dest='gui', action='store_false', default=True, help="suppress GUI interface/windows?")
