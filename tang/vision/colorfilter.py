...
class ColorFilterProcessor(FrameProcessor):
  ...
  def onKeyPress(self, key, keyChar=None):
    ...
    if keyChar == 'h' or keyChar == 'H':
      ...
      self.logger.info("Current filter: " + str(self.colorFilter))  # self.colorFilter.toXMLString()
      return True
    elif keyChar == 'w':
...
if __name__ == "__main__":
  ...
  run(ColorFilterProcessor(options))  # run a ColorFilterProcessor instance using main.main()
